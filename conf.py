...
BLOG_TITLE = "303 Publishing House"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.303publishinghouse.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.303publishinghouse.com/"
BLOG_EMAIL = "sales@303publishinghouse.com"
BLOG_DESCRIPTION = "Happenings"  # (translatable)
...
### FIXME: Move "Archive" and "Tags" to footer.
