.. title: LASTCALL Issue 1 Prerelease
...
<input type="hidden" name="on1" value="Notes">Notes:
<input type="text" name="os1" maxlength="200" size="50">
...
<div style="text-align: center; margin-top: 10px; margin-bottom: 10px;" >
<a href="http://lastcall.vegas"><img src="/galleries/LASTCALL-1/CoverLowRes.jpg" /></a><br /><br />
